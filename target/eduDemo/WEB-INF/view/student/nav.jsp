                ...
                <ul class="nav" id="side-menu">
                    <li>
                        <a href="${pageContext.request.contextPath}/student/main">
                            <i class="fa fa-book fa-fw"></i>个人主页
                        </a>
                    </li>
                    <li>
                        <a href="${pageContext.request.contextPath}/student/mycourse">
                            <i class="fa fa-book fa-fw"></i>我的课程
                        </a>
                    </li>
                    <li>
                        <a href="${pageContext.request.contextPath}/student/elect">
                            <i class="fa fa-book fa-fw"></i>我要选课
                        </a>
                    </li>
                </ul>
            </div>
